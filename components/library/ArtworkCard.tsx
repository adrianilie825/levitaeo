...
export default function ArtworkCard({ artwork }: ArtworkCardProps) {
  return (
    <article className="flex h-full flex-col border border-[#ECE8E2] bg-white">
      <div className="flex min-h-[220px] items-center justify-center bg-[#F7F5F1] px-4 py-6 sm:min-h-[240px]">
        <Image
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <h2 className="mt-2 text-xl font-light tracking-[-0.02em] text-[#111111]">
          {artwork.title}
        </h2>
        {artwork.subtitle ? (
        ...
        <dl className="mt-5 space-y-2 text-[12px] leading-5 text-neutral-600">
